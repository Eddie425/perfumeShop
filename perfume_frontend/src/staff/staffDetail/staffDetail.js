  ...
  const [product, setProduct] = useState([
    {
      ...
      description: "N°5 超越世代，歷久彌新 香奈兒女士以創造未來的的香氛為目標，打造出N°5。 結合花束馨香的前瞻性香氛創作，香氣中流淌著女性的 優雅姿態。 N°5成為未來的一部分",
      content: "N°5，女性魅力的極致精髓。散發經典傳奇的乙醛花束香氣。香精以頂級原材料製成，為香水最珍貴的表現形式。封存於極簡設計的獨特瓶身，採用Baudruchage 手工封瓶技術，並點綴如寶石切割般形態的瓶蓋。",
      price: "2,950",
